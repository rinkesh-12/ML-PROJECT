...
st.title('Car Prediction ML App')

cars_data = pd.read_csv("E:\\Data_Analysis_Datasets\\Cardetails.csv")
...
owner = st.selectbox('Seller  type', sorted(cars_data['owner'].unique()))
